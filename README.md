...
Для запуска проекта необходимо содержимое каталога deploy и каталог app разместить в корневой директории, далее следовать инструкциям из файла README.md находящегося в каталоге deploy
